...
func CreateAuth(service service.UserService, userName string, td *TokenDetails) error {
...
func FetchAuth(service service.UserService, authD *AccessDetails) (string, string, error) {
